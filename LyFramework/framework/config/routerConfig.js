    ...
    function (i18n, sprintf) {
        ...
        mod.run(function ($rootScope, $state, $urlService, $q) {
            ...
            $urlService.rules.otherwise(function(matchValue, urlParts, router) {
                ...
                if(stateModul) {
                    var stateConfigUrl = "app/"+ stateModul + "/" + stateModul + "Config";
        ...
        mod.controller("menusCtrl", ["$scope", "$rootScope", "$state","$urlRouter", "$window", "$q",
            function ($scope, $rootScope, $state, $urlRouter, $window, $q) {
